                	...
                	<!-- masterhead Right Section -->
                    		...
                    		<!-- top navigation -->
                    			<div class="topnavigation">
                               		<ul>
                                  		<li class="first">&nbsp;</li>
                                    	<li><a href="#">Telp. (0271) 08439274</a></li>
                                    	<li><a href="#">Email: sdn1dibal@gmail.com</a></li>
                                      <li><a class="nobg" href="#"> Jl. Gaten, Dibal</a></li>
                                    	<li class="last">&nbsp;</li>
                                    </ul>
                                </div>
                                <div class="clear"></div>
                                      ...
                                      <form action="<?php echo base_url().'berita/search'?>" method="post">
                                        <ul>
                                          <li><input name="textcari" type="text" placeholder="Pencarian" /></li>
                                            <li><button class="search" type="submit">Cari</button></li>
                                         </ul>
                                      </form>
                                  ...
                                  <div id="smoothmenu1" class="ddsmoothmenu">
                                      ...
                                      <li class="first"><a href="<?php echo base_url().''?>">Home</a></li>
                                          ...
                                          <li><a href="#">E-Learning</a>
                                              <ul>
                                                  <li><a href="http://localhost/ujianonline/admin">E-Learning Guru</a></li>
                                                  <li><a href="http://localhost/ujianonline/">E-Learning Siswa</a></li>
                                              </ul>     
                                          </li>
                                          <li><a href="http://localhost/ppdb">PPDB 2022</a> </li>
                                          <li><a href="<?php echo base_url().'pengumuman'?>">Pengunguman</a>
                                              <ul>
                    	...
                    	<!-- Banner -->
                         ...
                         <!-- Content Heading -->
                         	<div class="content_heading">
                            	<div class="heading"><h2>Selamat datang di SD Negeri 1 Dibal</h2> </div>
                          
                            </div>
                             <p class="text">
                                 Website SD Negeri 1 Dibal adalah website yang dibangun untuk sekolah dasar untuk menunjang transparasi informasi dan promosi sekolah.  
                                 <p>Kami Menyambut baik terbitnya Website SD Negeri 1 Dibal yang baru , dengan harapan dipublikasinya website ini sekolah berharap : 
                                  Peningkatan layanan pendidikan kepada siswa, orangtua, dan masyarakat pada umumnya semakin meningkat. Sebaliknya orangtua dapat mengakses 
                                  informasi tentang kegiatan akademik dan non akademik putra - puterinya di sekolah ini. Dengan fasilitas ini Siswa dapat mengakses berbagai
                                   informasi pembelajaran dan informasi akademik.</p>
                             </p>
                          <div class="clear"></div>
                             <!-- Content Block -->
