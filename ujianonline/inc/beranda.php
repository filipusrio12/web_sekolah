...
if(@$_GET['hal'] == '') { ?>
    <div class="row">
        <div class="col-md-12">
            <h4 class="page-head-line">Beranda Siswa</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-success">
                <center><a class="media-left" href="#">
                                <img src="img/foto_siswa/<?php echo $data_terlogin['foto']; ?>" class="img-rounded" /></a>
                </center>
                <center><h5>Kelas : <?php echo $data_terlogin['nama_kelas']; ?></h5></center>
                Hai, <?php echo $data_terlogin['nama_lengkap']; ?>.<br />
                Selamat datang di E-learning SD Negeri 1 Dibal.<br />
                Silahkan pilih menu sesuai kebutuhan Anda, jika ada yang kurang jelas silahkan bertanya kepada Operator atau Guru yang bersangkutan.
            </div>
        </div>
    </div>
<?php
