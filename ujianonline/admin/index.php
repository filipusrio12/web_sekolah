...
<head>
    ...
    <title><?php cek_session("Halaman Operator", "Halaman Pengajar"); ?> E-Learning</title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><?php cek_session("Operator", "Pengajar"); ?></a>
            </div>
                    ...
                    ?>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="?page=pengajar" class="<?php if(@$_GET['page'] == 'pengajar') { echo 'active-menu'; } ?>">&gt; Pengajar</a>
                                </li>
                                <li>
                                    <a href="?page=siswa" class="<?php if(@$_GET['page'] == 'siswa') { echo 'active-menu'; } ?>">&gt; Siswa</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
				...
				<footer><p> &copy; 2022 E-Learning SD Negeri 1 Dibal | By : Filipus Rio | B220181004 </p></footer>
            </div>
        </div>
    </div>
</body>
