        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-warning">
                    Operator tidak dapat mengedit data siswa. Operator hanya dapat mengaktifkan dan menonaktifkan serta menghapus akun siswa. Untuk mengedit data siswa yang berhak ialah siswa itu sendiri.
                </div>
            </div>
        </div>
    <?php
