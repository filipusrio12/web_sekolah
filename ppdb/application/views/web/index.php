...
<head>
    ...
    <title>PPDB Online | SD N 1 DIBAL</title>
            ...
            <div class="row">
                <div class="col-lg-12" >
                    ...
                    <div class="intro-text">
                        <span class="name shad" style="font-size:35px">PPDB ONLINE <br> SD Negeri 1 Dibal</span>

                        <br>
                      <?php if ($web_ppdb->status_ppdb == 'buka') {?>
                        <span class="skills">
                        	<a href="files/Panduan_PPDB_Online_SDN1_Dibal.pdf" class="btn btn-danger btn-lg"><i class="fa fa-file-pdf-o faa-pulse animated"></i> &nbsp;Download Panduan PPDB Online</a>
                        </span>
                        <br> <br>
                        <hr class="star-light">
												<br>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 portfolio-item">
                    <a href="http://localhost/web_sekolah/" target="_blank" class="portfolio-link">
                        <div class="caption">
                        ...
                        <span class="btn btn-success btn-block">sdn1dibal.com</span>
                    </a>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2" style="text-align:justify">
                    <p>SD Negeri 1 Dibal menyediakan PPDB secara <i>online</i> diharapkan proses PPDB dapat berjalan cepat
                    dan bisa dilakukan dimanapun dan kapanpun selama sesi PPDB Online dibuka. Proses pendaftaran calon siswa baru tidak menggunakan formulir konvensional hanya dengan mengakses website PPDB Online SD Negeri 1 Dibal. </p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="col-lg-12 text-center">
                                ...
                                <li>Calon Siswa mendaftarkan diri atau melakukan <b><a href="pendaftaran">Pendaftaran PPDB <i>online</i></a></b> melalui website <b><a href="">PPDB SD Negeri 1 Dibal</a></b>.</li>
                                <li>Setelah Calon Siswa berhasil melakukan pendaftaran, Calon siswa wajib melakukan <b>Print Out Pendaftaran & Mempersiapkan Kelengkapan Berkas PPDB SD Negeri 1 Dibal</b>.</li>
                                <li>Calon siswa datang ke SD Negeri 1 Dibal untuk <b>VERIFIKASI</b>, membawa <b>Bukti pendaftaran & Kelengkapan Berkas PPDB SD Negeri 1 Dibal</b>. </li>
                                ...
                                <li>Jika Calon Siswa sudah mengambil <b>NOMOR TEST & Pengecekan Ruang Ujian</b> selanjutnya Calon Siswa wajib melakukan <b>TEST tertulis POTENSI AKADEMIK</b>.</li>
																<li>PENGUMUMAN HASIL PPDB Online bisa dilihat di Web PPDB SD Negeri 1 Dibal. Untuk <b>No. Pendaftaran</b> sesuaikan dengan <b>Formulir No. Pendaftaran</b> & <b>Passwordnya</b> yaitu <b>NISN</b> Calon Siswa tersebut.</li>
																<li>Jika Calon Siswa dinyatakan <b>LULUS</b> maka Calon Siswa Wajib <b>Registrasi/Daftar Ulang</b> di <b>SD Negeri 1 Dibal</b>.</li>
															</ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row" style="margin-top:-100px;margin-bottom:-105px;">
                <div class="col-lg-4 text-center">
                  <br><br>
                    ...
                    <hr class="star-light">
                    <h4>
                    Gaten, Dibal, Kec. Ngemplak, Kabupaten Boyolali, Jawa Tengah <br><br>
                    </h4>
                    ...
                    <br>
                    <a href="http://localhost/web_sekolah/" target="_blank"><h4 class="btn btn-success">SMA NEGERI 1 BELITANG </h4></a>
                </div>
                <div class="col-lg-8 text-center">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7911.252668464759!2d110.76554602421562!3d-7.506437528342628!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a13983bda215b%3A0xc61c034a1277fa73!2sSD%20Negeri%201%20Dibal!5e0!3m2!1sid!2sid!4v1656173070318!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              	</div>
            </div>
        <!-- </div> -->
    </section>
    ...
    <footer class="text-center">
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; <a href="http://localhost/web_sekolah/" target="_blank">SD Negeri 1 Dibal</a> <?php echo date('Y'); ?> | IT Development
                    </div>
                </div>
            </div>
        </div>
